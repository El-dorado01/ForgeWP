      ...
      <Route>
        <div className='flex min-h-[60vh] flex-col items-center justify-center text-center p-6'>
          ...
          <div className='mt-4 flex flex-col items-center gap-2 text-sm'>
            ...
            <a
              href='/query-sandbox'
              className='text-zinc-500 font-mono hover:underline text-xs'
            >
