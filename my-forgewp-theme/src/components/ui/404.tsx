export function NotFoundPage() {
  return (
    <div className='relative flex min-h-[70vh] flex-col items-center justify-center bg-zinc-50 px-6 py-24 text-center overflow-hidden'>
      ...
      <div className='absolute inset-0 -z-10 h-full w-full bg-white bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)]'></div>
