  ...
  return (
    <main className="container mx-auto px-6 py-12">
      ...
      <SEO 
        ...
        description="Explore our exclusive Terms of Service section, dynamically loaded in Headless React." 
      />

      {/* Hero Header Area */}
      <header className="border-b-4 border-black pb-6 mb-12">
        <h1 className="text-5xl font-black tracking-tight uppercase">Terms of Service</h1>
        <p className="text-zinc-500 mt-2 text-lg">
          Auto-generated template. Edit <code className="bg-zinc-100 px-1 py-0.5 rounded text-sm text-red-600 font-mono">src/app/pages/TermsOfServicePage.tsx</code> to customize this page.
        </p>
      </header>
