import { WpQueryLoop, useWpTitle, useWpFeaturedImage, useWpExcerpt, useWpPermalink } from "@/.forgewp/wordpress";

/**
 * ⚡ ForgeWP Custom Post Type Template — "LegacyTestComponent"
 * 
 * This loop template dynamically queries and renders records of the "post" post type.
 ...
 */
export default function LegacyTestComponent() {
  return (
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="mb-12 border-4 border-zinc-950 bg-white p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
          ...
          <p className="text-sm font-mono font-medium text-zinc-600 mt-2">
            Dynamic Post-Type Template &bull; Querying: "post"
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <WpQueryLoop postType="post" postsPerPage={6}>
            ...
            {/* No custom fields registered in mock-data.json. Add fields by running forgewp make:post-type */}
            <p className="text-xs text-zinc-500 font-mono italic">No custom fields configured for post type: post</p>
              </div>
            </article>
          </WpQueryLoop>
        </div>
