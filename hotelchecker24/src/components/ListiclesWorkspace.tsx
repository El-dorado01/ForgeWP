            ...
            <>
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
                {filtered.map((listicle) => {
                  ...
                  const catTerms: any[] =
                    (listicle as any)._terms?.category || [];

                  return (
                    <WpLink
                      key={listicle.id}
                      href={
                        listicle.permalink || `/hotelvergleich/${listicle.id}`
                      }
                    ...
                    >
                      ...
                      <div className='p-5 flex flex-col grow'>
                        ...
                        {/* Title */}
                        <h2 className='text-sm font-bold text-slate-900 group-hover:text-primary transition-colors duration-200 leading-snug line-clamp-2 grow mb-2'>
                          {listicle.title}
                        </h2>
