...
export function HotelsPage() {
  return (
    <main className="container mx-auto px-6 py-12 font-sans text-slate-900">
      ...
      <WpHead 
        title="Hotels" 
        description="Explore our exclusive Hotels section, dynamically loaded in Headless React." 
      />

      {/* Hero Header Area */}
      <header className="border-b border-slate-100 pb-6 mb-12">
        <h1 className="text-5xl font-black tracking-tight uppercase text-slate-900">Hotels</h1>
        <p className="text-slate-500 mt-2 text-sm">
          Auto-generated template. Edit <code className="bg-slate-50 px-1 py-0.5 border border-slate-100 text-xs text-primary font-mono">src/app/pages/HotelsPage.tsx</code> to customize this page.
        </p>
      </header>
