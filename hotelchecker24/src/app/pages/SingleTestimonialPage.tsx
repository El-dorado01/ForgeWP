 ...
 * 
 * This file was generated automatically for the custom post type "testimonial".
...
export function SingleTestimonialPage() {
  const [, params] = useRoute("/testimonial/:id");
  ...
  // Local development mock query for single testimonial
