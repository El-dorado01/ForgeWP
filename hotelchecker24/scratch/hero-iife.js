(() => {
const defaults = {"hero_title":"Handverlesene","hero_title_colored":"Boutique- & Luxushotels","hero_subtitle":"Hotelchecker24 ist Ihre unabhÃ¤ngige Magazin-Plattform fÃ¼r auÃergewÃ¶hnliche Aufenthalte. Entdecken Sie handverlesene Empfehlungen, redaktionelle Berichte und versteckte Juwelen in ganz Europa.","hero_search_placeholder":"Hotelname oder Stadt suchen...","trust_stat1_value":"500+","trust_stat1_label":"Kuratierte Hotels","trust_stat2_value":"4","trust_stat2_label":"LÃ¤nder abgedeckt","trust_stat3_value":"100%","trust_stat3_label":"UnabhÃ¤ngig & redaktionell","trust_stat4_value":"DE / EN","trust_stat4_label":"Deutsch & Englisch","featured_badge":"Empfohlen","featured_heading":"AusgewÃ¤hlte Hotels","featured_subtitle":"Von unserer Redaktion handverlesen â auÃergewÃ¶hnliche Aufenthalte in ganz Europa.","featured_link_label":"Alle Hotels","editorial_badge":"Redaktionell & UnabhÃ¤ngig","editorial_heading":"Kuratiert von","editorial_heading_colored":"echten Reisenden","editorial_description":"Kein bezahltes Ranking. Kein Algorithmus. Nur ehrliche, redaktionell geprÃ¼fte Empfehlungen von unserem Team, das die Hotels selbst besucht hat.","editorial_cta_label":"Alle Hotelvergleiche lesen","editorial_feature1_label":"Vor-Ort-Besuche","editorial_feature1_desc":"Jedes Hotel wird persÃ¶nlich getestet","editorial_feature2_label":"Keine Werbung","editorial_feature2_desc":"VollstÃ¤ndig redaktionell unabhÃ¤ngig","editorial_feature3_label":"DE & EN","editorial_feature3_desc":"Inhalte auf Deutsch und Englisch","editorial_feature4_label":"Laufend aktuell","editorial_feature4_desc":"RegelmÃ¤Ãige neue Empfehlungen","listicles_badge":"Magazin","listicles_heading":"Aktuelle Hotelvergleiche","listicles_subtitle":"Tiefgehende Reiseberichte und Empfehlungen von unserer Redaktion.","listicles_link_label":"Alle Vergleiche","destinations_heading":"Nach Reiseziel entdecken","destinations_subtitle":"Handverlesene Hotels in den schÃ¶nsten Reisezielen Europas."};
const BAKED_PADDING = "lg";
...
// Dual-host prop aliases (block attributes â *Prop names used in components)
const __attr = (typeof attributes === 'object' && attributes) ? attributes : {};
const titleProp = (typeof __attr["title"] !== 'undefined') ? __attr["title"] : (typeof __attr["titleProp"] !== 'undefined' ? __attr["titleProp"] : undefined);
const titleColoredProp = (typeof __attr["titleColored"] !== 'undefined') ? __attr["titleColored"] : (typeof __attr["titleColoredProp"] !== 'undefined' ? __attr["titleColoredProp"] : undefined);
const subtitleProp = (typeof __attr["subtitle"] !== 'undefined') ? __attr["subtitle"] : (typeof __attr["subtitleProp"] !== 'undefined' ? __attr["subtitleProp"] : undefined);
const searchPlaceholderProp = (typeof __attr["searchPlaceholder"] !== 'undefined') ? __attr["searchPlaceholder"] : (typeof __attr["searchPlaceholderProp"] !== 'undefined' ? __attr["searchPlaceholderProp"] : undefined);
const paddingYProp = (typeof __attr["paddingY"] !== 'undefined') ? __attr["paddingY"] : (typeof __attr["paddingYProp"] !== 'undefined' ? __attr["paddingYProp"] : undefined);
...
function handleClickOutside(event) {
  ...
  const titleColored = setAttributes ? (titleColoredProp ?? titleColoredMeta) : titleColoredMeta;
  const subtitle = setAttributes ? (subtitleProp ?? subtitleMeta) : subtitleMeta;
  const searchPlaceholder = setAttributes
    ? (searchPlaceholderProp ?? searchPlaceholderMeta)
    : searchPlaceholderMeta;
  ...
  // Build dropdown options â always include an "all" entry first
  const categories = [
