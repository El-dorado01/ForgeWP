...
return createElement("section", { className: "relative w-full overflow-hidden bg-slate-50 selection:bg-primary selection:text-white py-12 sm:py-20 lg:py-24 px-4 sm:px-6 lg:px-8" }, createElement("div", { className: "absolute top-0 right-0 w-150 h-150 bg-[radial-gradient(circle,rgba(109,155,174,0.12)_0%,transparent_70%)] blur-3xl pointer-events-none z-0" }), createElement("div", { className: "absolute bottom-0 left-0 w-125 h-125 bg-[radial-gradient(circle,rgba(146,159,93,0.08)_0%,transparent_70%)] blur-3xl pointer-events-none z-0" }), createElement("div", { className: "relative max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center z-10" }, createElement("div", { className: "lg:col-span-7 flex flex-col items-start text-left" }, createElement("h1", { className: "text-4xl sm:text-5xl md:text-6xl font-sans font-black tracking-tight text-slate-800 leading-[1.1] mb-6 uppercase" }, createElement(wp.blockEditor.RichText, {
        tagName: "span",
